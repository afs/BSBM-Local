...
public class XMLSerializer implements Serializer {
    ...
    public void gatherData(ObjectBundle bundle) {
		...
		try {
			fileWriter.append(startTagWA(2,publisherType,"id",Integer.valueOf(bundle.getPublisherNum()).toString()));
	...
	private String convertProductType(ProductType pType)
	{
		...
		result.append(startTagWA(3, "ProductType", "id", Integer.valueOf(pType.getNr()).toString()));
	...
	private String convertOffer(Offer offer)
	{
		...
		result.append(startTagWA(3, "Offer", "id", Integer.valueOf(offer.getNr()).toString()));
	...
	private String convertProduct(Product product)
	{
		StringBuffer result = new StringBuffer();
		//First the uriref for the subject
		result.append(startTagWA(3, "Product", "id", Integer.valueOf(product.getNr()).toString()));
		...
		if(forwardChaining) {
			...
			while(pt!=null) {
				result.append(leafTag(4, "type", Integer.valueOf(pt.getNr()).toString()));
				pt = pt.getParent();
			}
		}
		else {
			result.append(leafTag(4, "type", Integer.valueOf(product.getProductType().getNr()).toString()));
		}

		//bsbm:producer
		result.append(leafTag(4, "producer", Integer.valueOf(product.getProducer()).toString()));
		...
		//dc:publisher
		result.append(leafTag(4, "publisher", Integer.valueOf(product.getProducer()).toString()));
	...
	private String convertPerson(Person person)
	{
		StringBuffer result = new StringBuffer();
		//First the uriref for the subject
		result.append(startTagWA(3, "Person", "id", Integer.valueOf(person.getNr()).toString()));
	...
	private String convertProducer(Producer producer)
	{
		StringBuffer result = new StringBuffer();
		//First the uriref for the subject
		result.append(startTagWA(3, "Producer", "id", Integer.valueOf(producer.getNr()).toString()));
		...
		//dc:publisher
		result.append(leafTag(4, "publisher", Integer.valueOf(producer.getNr()).toString()));
	...
	private String convertProductFeature(ProductFeature pf)
	{
		StringBuffer result = new StringBuffer();
		//First the uriref for the subject
		result.append(startTagWA(3, "ProductFeature", "id", Integer.valueOf(pf.getNr()).toString()));
	...
	private String convertVendor(Vendor vendor)
	{
		StringBuffer result = new StringBuffer();
		//First the uriref for the subject
		result.append(startTagWA(3, "Vendor", "id", Integer.valueOf(vendor.getNr()).toString()));
		...
		//dc:publisher
		result.append(leafTag(4, "publisher",  Integer.valueOf(vendor.getNr()).toString()));
	...
	private String convertReview(Review review)
	{
		StringBuffer result = new StringBuffer();
		//First the uriref for the subject
		result.append(startTagWA(3, "Review", "id", Integer.valueOf(review.getNr()).toString()));

		//bsbm:reviewFor
		result.append(leafTag(4, "reviewfor", review.getProduct().toString()));

		//rev:reviewer
		result.append(leafTag(4, "reviewer", Integer.valueOf(review.getPerson()).toString()));
